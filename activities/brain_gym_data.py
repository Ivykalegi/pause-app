brain_gym_activities = [
    {'id': 1, 'name': 'Cross Crawl', 'type': 'Brain Gym', 'duration': '3 minutes',
    ...
    {'id': 2, 'name': 'Muscle Dance', 'type': 'Brain Gym', 'duration': '7 minutes',
    ...
    {'id': 3, 'name': 'Muscle Dance (easy)', 'type': 'Brain Gym', 'duration': '3 minutes',
     'benefits': 'Muscle dance exercises help improve the coordination between the '
                 'right and left brain.', 'instructions': 'https://www.youtube.com/watch?v=YzJKug_IMZ0'},
    {'id': 4, 'name': 'Neck Circles', 'type': 'Brain Gym', 'duration': '3 minutes',
    ...
    {'id': 5, 'name': 'Lazy 8', 'type': 'Brain Gym', 'duration': '3 minutes',
    ...
    {'id': 6, 'name': 'Thinking Cap', 'type': 'Brain Gym', 'duration': '3 minutes',
    ...
    {'id': 8, 'name': 'Belly Breathing (short)', 'type': 'Brain Gym', 'duration': '2 minutes',
     'benefits': 'Belly breathing helps increase oxygen supply in the body, which, in turn, '
                 'helps you relax and improves your reading and speaking abilities.',
     'instructions': 'https://www.youtube.com/watch?v=qTN_MtV5TFw'},
    {'id': 9, 'name': 'Positive Points', 'type': 'Brain Gym', 'duration': '3 minutes',
