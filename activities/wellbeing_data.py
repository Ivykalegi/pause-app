wellbeing_activities = [
    {'id': 1, 'name': 'Read an inspirational quote', 'type': 'Wellbeing Activity', 'duration': '5 minutes', 'benefits': 'Feel '
    'inspired and motivated by reading words of advice.', 'instructions': 'Do not let yesterday take up too much of today ' 
    '- Will Rogers'}, 
    {'id': 2, 'name': 'Learn a new number fact', 'type': 'Wellbeing Activity', 'duration': '5 minutes', 'benefits': 'Expand your '
    ...
    {'id': 3, 'name': 'Stretch', 'type': 'Wellbeing Activity', 'duration': '5 minutes', 'benefits': 'Move your body to help reset ' 
    ...
    {'id': 4, 'name': 'Refresh', 'type': 'Wellbeing Activity', 'duration': '5 minutes', 'benefits': 'Movement of your body helps to refresh '
    ...
    {'id': 5, 'name': 'Hydrate', 'type': 'Wellbeing Activity', 'duration': '5 minutes', 'benefits': 'Water is crucial for a healthy '
    ...
    {'id': 6, 'name': 'Connect', 'type': 'Wellbeing Activity', 'duration': '5 minutes', 'benefits': 'Relationships with people is an '
    ...
    {'id': 7, 'name': 'Aspire', 'type': 'Wellbeing Activity', 'duration': '5 minutes', 'benefits': 'Learning a new skill is a good boost to your '
    ...
    {'id': 8, 'name': 'Kindness', 'type': 'Wellbeing Activity', 'duration': '5 minutes', 'benefits': 'Giving to others and acts of kindness are ' 
    ...
    {'id': 9, 'name': 'Mindfulness', 'type': 'Wellbeing Activity', 'duration': '5 minutes', 'benefits': 'Mindfulness and being aware of the world ' 
    ...
    {'id': 10, 'name': '5 Finger Breathing', 'type': 'Wellbeing Activity', 'duration': '5 minutes', 'benefits': 'Slow, medatative breathing helps your '
